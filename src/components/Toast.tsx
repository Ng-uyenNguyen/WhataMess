...
export const Toast = ({ type, text, show, setShow }: PropTypes) => {
  ...
  return (
    <Transition show={show} enter="transition duration-700" enterFrom="opacity-0" enterTo="opacity-100" leave="transition duration-500" leaveFrom="opacity-100 top-0" leaveTo="opacity-0 top-10">
      {renderSwitch(type)}
    </Transition>
  );
};
